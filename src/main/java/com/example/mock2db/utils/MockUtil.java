package com.example.mock2db.utils;
...
public class MockUtil {
    ...
    //把mock-min.js文件放在resources文件夹下
    private static  final String jsPath = "mock-min.js";
    ...
    public static Object mockRandom(String script) throws ScriptException {
        // 把mockjs读取到缓存
        if (lfuCache.isEmpty()) {
            String scriptString = FileUtil.readUtf8String(jsPath);
//            String scriptString = FileUtil.readUtf8String(Tools.getRootPath() + "/static/mock-min.js");
